...
class LocalAgent(Agent):
    def __init__(self) -> None:
        stt = openai.STT(base_url=os.getenv("WHISPER_URL", "http://localhost:11435/v1"), model="Systran/faster-whisper-small")
        llm = openai.LLM(base_url=os.getenv("OLLAMA_URL", "http://localhost:11434/v1"), model="gemma3:1b", timeout=30)
        tts = groq.TTS(base_url=os.getenv("KOKORO_URL", "http://localhost:8880/v1"), model="kokoro", voice="af_nova")
